		...
		<div className="">
			...
			<div className="flex flex-col gap-6 items-center justify-center mt-12">
				<div className="flex items-center justify-center w-full max-w-xl">
					...
					<h1 className="text-4xl nunito text-center w-full">
						Focus Areas
					</h1>
					<hr className="w-2/3  border-white/40" />
				</div>
				<div className="flex flex-row items-center justify-center w-full max-w-2xl gap-6">
					{focusAreas.map((focusArea, index) => (
						<div
							key={index}
							className="flex flex-col items-center justify-center border border-white/40 gap-3 bg-black/80 rounded-sm px-3 py-5 nunito text-white/80 w-full"
						>
							{focusArea.icon}
