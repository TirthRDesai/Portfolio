...
function Introduction() {
    ...
    useEffect(() => {
        if (device) {
            const mainDIV = document.querySelector('#Introduction')
            if (device == 'MOBILE') {
                mainDIV.style.flexDirection = 'column-reverse'
                mainDIV.style.gap = '3rem'
    ...
    useEffect(() => {
        if (theme) {
            ...
            if (theme.type == "dark") {
                ...
                IntroductionLayout.style.borderImage = 'fill 0 linear-gradient(#0001, #0001, #EE6C45)'
            } else {
                const IntroductionLayout = document.querySelector("#Introduction")
                IntroductionLayout.style.borderImage = 'fill 0 linear-gradient(#fff1, #fff1, #fff1, #fff)'
            }
        }
    }, [theme])
    ...
    */
    ...
    return (
        <div className={styles.IntroductionLayout + ' w-[100vw] h-[100vh] max-h-[100vh] max-w-[100vw] flex flex-row items-center justify-center gap-[10rem]'} id='Introduction' style={{
            ...
            <div className='details flex flex-col justify-center items-start' >
                <h1 className={styles.greetings + ' greetings text-5xl font-bold'} style={{
                    transition: 'all 0.7s ease-in-out',
                    color: theme.IntroductionText
                }}>Hi There!</h1>
                <p className={styles.Information + ' relative Information text-5xl mt-4'} style={{
                    transition: 'all 0.7s ease-in-out',
                    color: theme.IntroductionText
                }}>I{`'`}m <strong className={styles.Name + " underline underline-offset-[8px]"} style={{
                    transition: 'all 0.7s ease-in-out',
                    color: theme.IntroductionText
            ...
            <div className={styles.PortfolioImage + ` PortfolioImage h-[250px] w-[200px] border-2 rounded-full`} style={{
                transition: 'all',
